...
export const JobBoard = ({
  ...
  <section className="mx-auto flex w-full max-w-7xl flex-col gap-4 rounded-3xl border border-gi-ash p-6 bg-linear-to-t from-white to-[color-mix(in_oklch,var(--gi-blue)_10%,white)]">
    <JobBoardToolbar
